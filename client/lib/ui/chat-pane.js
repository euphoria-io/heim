...
export default React.createClass({
  ...
  render() {
    ...
    const entryFocus = this.state.activity.windowFocused && this.state.chat.connected !== false && !this.state.ui.modalDialog && this.state.ui.focusedPane === this.props.pane.id
